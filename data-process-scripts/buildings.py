...
with open('wenbao.csv') as wenbao, open('pre1979.csv') as pre1979, open('youxiu.csv') as youxiu:
    ...
    for row_w in wenbao_list:
        ...
        if row_w['id'] not in wenbao_id_set:
            buildings_macro_list.append(building)
            wenbao_id_set.add(row_w['id'])
with open('buildings.json', 'w') as jsonOutput:
